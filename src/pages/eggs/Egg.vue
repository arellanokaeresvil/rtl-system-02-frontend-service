<template>
    <Skeleton v-show="egg.loading" />
   <div v-show="!egg.loading" class="m-5">
    <!-- Content Header -->
        <ContentHeader 
        title="Egg Production Monitoring" 
        description="Track and record daily egg production" 
        button="Record Production"
        route="/egg-production/create" />
